...
// Pano2VR 5.0.1/15068
// Filename: my_template1.ggsk
// Generated Ср июл 4 18:33:07 2018
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._controller.ggUpdateConditionTimer=function () {
			...
			if (me._controller.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me._controller.ggCurrentLogicStatePosition == 0) {
					...
					me._controller.ggLeft=-168;
					me._controller.ggTop=-62;
					me._controller.ggUpdatePosition();
				}
			}
		}
		...
		this._gyroscope=document.createElement('div');
		this._gyroscope__img=document.createElement('img');
		this._gyroscope__img.className='ggskin ggskin_svg';
		this._gyroscope__img.setAttribute('src',basePath + 'images/gyroscope.svg');
		this._gyroscope__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;');
		this._gyroscope__img['ondragstart']=function() { return false; };
		this._gyroscope.appendChild(this._gyroscope__img);
		this._gyroscope__imgo=document.createElement('img');
		this._gyroscope__imgo.className='ggskin ggskin_svg';
		this._gyroscope__imgo.setAttribute('src',basePath + 'images/gyroscope__o.svg');
		this._gyroscope__imgo.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;');
		this._gyroscope__imgo['ondragstart']=function() { return false; };
		this._gyroscope.appendChild(this._gyroscope__imgo);
		this._gyroscope.ggId="gyroscope";
		this._gyroscope.ggLeft=-94;
		this._gyroscope.ggTop=-46;
		this._gyroscope.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._gyroscope.ggVisible=true;
		this._gyroscope.className='ggskin ggskin_svg ';
		this._gyroscope.ggType='svg';
		hs ='';
		hs+='height : 40px;';
		hs+='left : -94px;';
		hs+='position : absolute;';
		...
		hs+='visibility : inherit;';
		hs+='width : 40px;';
		this._gyroscope.setAttribute('style',hs);
		this._gyroscope.style[domTransform + 'Origin']='50% 50%';
		me._gyroscope.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._gyroscope.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._gyroscope.onclick=function () {
			gyro.toggle();
		}
		this._gyroscope.onmouseover=function () {
			me._gyroscope__img.style.visibility='hidden';
			me._gyroscope__imgo.style.visibility='inherit';
		}
		this._gyroscope.onmouseout=function () {
			me._gyroscope__img.style.visibility='inherit';
			me._gyroscope__imgo.style.visibility='hidden';
		}
		me._gyroscope.ggCurrentLogicStateVisible = -1;
		this._gyroscope.ggUpdateConditionNodeChange=function () {
			var newLogicStateVisible;
			if (
				(me.player.getIsMobile() == true)
			)
			...
			if (me._gyroscope.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._gyroscope.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._gyroscope.style[domTransition]='';
				if (me._gyroscope.ggCurrentLogicStateVisible == 0) {
					me._gyroscope.style.visibility=(Number(me._gyroscope.style.opacity)>0||!me._gyroscope.style.opacity)?'inherit':'hidden';
					me._gyroscope.ggVisible=true;
				}
				else {
					me._gyroscope.style.visibility=(Number(me._gyroscope.style.opacity)>0||!me._gyroscope.style.opacity)?'inherit':'hidden';
					me._gyroscope.ggVisible=true;
		...
		this._gyroscope.ggUpdatePosition=function () {
			this.style[domTransition]='none';
			if (this.parentNode) {
				var w=this.parentNode.offsetWidth;
		...
		this._gyroscope.ggNodeChange=function () {
			me._gyroscope.ggUpdateConditionNodeChange();
		}
		this._controller.appendChild(this._gyroscope);
		...
		this._userdata.ggLeft=-116;
		this._userdata.ggTop=-64;
		...
		this._datetime.appendChild(this._userdatabg);
		...
		this._datetime.appendChild(this._title);
		...
		this._datetime.appendChild(this._description);
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		if (hotspot.skinid=='ht_node') {
			...
			this._hsimage_node__imga=document.createElement('img');
			this._hsimage_node__imga.className='ggskin ggskin_svg';
			this._hsimage_node__imga.setAttribute('src',basePath + 'images/hsimage_node__a.svg');
			this._hsimage_node__imga.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;');
			this._hsimage_node__imga['ondragstart']=function() { return false; };
			this._hsimage_node.appendChild(this._hsimage_node__imga);
			...
			this._hsimage_node.onmouseover=function () {
				me._hsimage_node__img.style.visibility='hidden';
				me._hsimage_node__imgo.style.visibility='inherit';
			}
			this._hsimage_node.onmouseout=function () {
				me._hsimage_node__img.style.visibility='inherit';
				me._hsimage_node__imgo.style.visibility='hidden';
				me._hsimage_node__imga.style.visibility='hidden';
			}
			this._hsimage_node.onmousedown=function () {
				me._hsimage_node__imga.style.visibility='inherit';
				me._hsimage_node__imgo.style.visibility='hidden';
			}
			this._hsimage_node.onmouseup=function () {
				me._hsimage_node__imga.style.visibility='hidden';
				me._hsimage_node__imgo.style.visibility='inherit';
			}
